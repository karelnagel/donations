import { JSONValueKind, log } from "@graphprotocol/graph-ts"
import { ipfs, json } from '@graphprotocol/graph-ts'
import { getCollection } from "./initializers";

export function getCollectionIpfs(title: string, ipfsHash: string): void {
